...
$(document).ready(() => {
	...
	$(".modal-trigger").on('click', function(){
		...
		if(buttons[0] == "null")
			$(".modal-btn-access").attr('disabled', 'disabled');
		else{
			$(".modal-btn-access").removeAttr('disabled');
			$(".modal-btn-access").attr('href', buttons[0]);
		}
		if(buttons[1] == "null")
			$(".modal-btn-github").attr('disabled', 'disabled');
		else{
			$(".modal-btn-github").removeAttr('disabled');
